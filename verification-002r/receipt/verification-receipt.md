...
| GRAPH HASH | v3 219f692358beb0510c5bd51935390b2eadde98e838b9408e66802b8a2054bc2a (covers 18 events through EVENT-018) |
| COST | 18 ledger events; LEAN_BUILD_TIME=NOT RECORDED; COMPUTATIONAL_TEST_TIME=7.19; CHECKER_TIME=NOT RECORDED; HUMAN_TIME, MODEL_CALL_COUNT, MODEL_COST, LATEX_BUILD_TIME=NOT RECORDED (no cost ledger, §43) |
| FINAL DECISION | PROMOTE |
| LIMITATIONS | 10/18 events lack INPUT/OUTPUT_HASH (§25; legacy events, not backfilled); EVENT-009 uses non-§16 wording (COMPUTATIONALLY_SUPPORTED); read as DIAGNOSTIC |
...
|---|---|---|---|---|---|---|
| CLAIM-002 | PASS | PASS | PASS | DIAGNOSTIC (no counterexample in tested domain) | PASS / PASS | 10/18 events lack INPUT/OUTPUT_HASH (§25; legacy events, not backfilled); EVENT-009 uses non-§16 wording (COMPUTATIONALLY_SUPPORTED); read as DIAGNOSTIC |
...
Covers ledger through `EVENT-018` (`78773f369808b91d…`). Run `fcve.py receipt-check` to detect staleness.
