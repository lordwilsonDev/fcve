...
| GRAPH HASH | v3 97d4d865cec2cdc842e0714af1a2a030fd62d0397e9e7327c9b74ebe67a09c54 (covers 16 events through EVENT-016) |
| COST | 16 ledger events; LEAN_BUILD_TIME=NOT RECORDED; COMPUTATIONAL_TEST_TIME=7.19; CHECKER_TIME=NOT RECORDED; HUMAN_TIME, MODEL_CALL_COUNT, MODEL_COST, LATEX_BUILD_TIME=NOT RECORDED (no cost ledger, §43) |
| FINAL DECISION | PROMOTE |
| LIMITATIONS | 10/16 events lack INPUT/OUTPUT_HASH (§25; legacy events, not backfilled); EVENT-009 uses non-§16 wording (COMPUTATIONALLY_SUPPORTED); read as DIAGNOSTIC |
...
Covers ledger through `EVENT-016` (`6e2047c1f2c38b6b…`). Run `fcve.py receipt-check` to detect staleness.
