...
| GRAPH HASH | v3 b6fd7481e3a1a68789bef42f24c444491b0ed171591d7f19d5507d9a890f4149 (covers 16 events through EVENT-016) |
| COST | 16 ledger events; LEAN_BUILD_TIME=NOT RECORDED; COMPUTATIONAL_TEST_TIME=NOT RECORDED; CHECKER_TIME=NOT RECORDED; HUMAN_TIME, MODEL_CALL_COUNT, MODEL_COST, LATEX_BUILD_TIME=NOT RECORDED (no cost ledger, §43) |
| FINAL DECISION | PROMOTE |
| LIMITATIONS | 10/16 events lack INPUT/OUTPUT_HASH (§25; legacy events, not backfilled); EVENT-009 uses non-§16 wording (COMPUTATIONALLY_SUPPORTED); read as DIAGNOSTIC; The Gate 8 search examined k = 0 to 20 and k = 50, 100, 500 and 1000 only; no other values of k were tested by that script (stated by Wilson) |
...
| G11 | EVIDENCE_GRAPH | EVENT-012 | PASS | yes |  |
| G12 | REPORT_GENERATION | EVENT-015 | PASS | yes |  |
| G13 | GOVERNANCE_DECISION | EVENT-016 | DECIDED | yes |  |
...
|---|---|---|---|---|---|---|
| CLAIM-002 | PASS | PASS | PASS | DIAGNOSTIC (no counterexample in tested domain) | PASS / PASS | 10/16 events lack INPUT/OUTPUT_HASH (§25; legacy events, not backfilled); EVENT-009 uses non-§16 wording (COMPUTATIONALLY_SUPPORTED); read as DIAGNOSTIC |
...
Covers ledger through `EVENT-016` (`ced80197668d664a…`). Run `fcve.py receipt-check` to detect staleness.
